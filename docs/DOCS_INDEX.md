...
canonical_ref: docs/DOCS_INDEX.md
...
- docs/historical/LanceDB_Assessment.md
...
- docs/RAG_Pipeline_Backend_Assessment.md
- docs/Project_Critique.md
- docs/analysis_results.md
- docs/Analysis on Immediate non-negotiable steps.md
- docs/LanceDB_Assessment.md
- docs/test_smart.md
...
- Legacy root-level files are retained as compatibility stubs that link to relocated documents.
- Validation target: every markdown file under docs must appear here exactly once.
